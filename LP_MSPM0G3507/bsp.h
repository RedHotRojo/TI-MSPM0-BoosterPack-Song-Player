...
#define ONE_MICROSECOND_DELAY CPUCyclesPer1us()
#define ONE_MILLISECOND_DELAY CPUCyclesPer1ms()
...
#define RGB_RED_LED_INDEX       PB26INDEX
#define RGB_GREEN_LED_INDEX     PB27INDEX
#define RGB_BLUE_LED_INDEX      PB22INDEX
...
#define RGB_RED_LED_PIN 26
#define RGB_RED_LED_MASK ((uint32_t) (0x00000001U << RGB_RED_LED_PIN))
#define RGB_RED_LED_PORT GPIOB

#define RGB_GREEN_LED_PIN 27
#define RGB_GREEN_LED_MASK ((uint32_t) (0x00000001U << RGB_GREEN_LED_PIN))
#define RGB_GREEN_LED_PORT GPIOB

#define RGB_BLUE_LED_PIN 22
#define RGB_BLUE_LED_MASK ((uint32_t) (0x00000001U << RGB_BLUE_LED_PIN))
#define RGB_BLUE_LED_PORT GPIOB
...
#define GPIO_POLARITY_15_0(PIN,EDGE) ((uint32_t) (EDGE << (2*PIN)))
#define GPIO_POLARITY_31_16(PIN,EDGE) ((uint32_t) (EDGE << (2*(PIN-16))))
...
// Function prototypes
/**
 * @brief  Based on ClockFrequency, return number of CPU cycles in 1 us.
 * @retval CPU cycles per 1 us
 */
uint32_t CPUCyclesPer1us(void);

/**
 * @brief  Based on ClockFrequency, return number of CPU cycles in 1 ms.
 * @retval CPU cycles per 1 ms
 */
